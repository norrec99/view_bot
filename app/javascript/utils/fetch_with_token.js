...
const retrieveReviews = (application_id, package_name) => {
  ...
  const test_url = 'https://cors-anywhere.herokuapp.com/https://data.42matters.com/api/v2.0/android/apps/reviews.json?p=com.facebook.katana&access_token=d41b89aefcb3e9807a1cf88143523571bf25d5e36&limit=100'
  const real_url = `https://cors-anywhere.herokuapp.com/https://data.42matters.com/api/v2.0/android/apps/reviews.json?p=${package_name}&access_token=d41b89aefcb3e9807a1cf88143523571bf25d5e36&limit=100`
